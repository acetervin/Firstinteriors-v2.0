  ...
  return (
    <footer className="bg-gray-900 text-white">
      <section className="py-24 px-6 md:px-20 container mx-auto">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-heading mb-8 leading-tight max-w-3xl">
          ...
          <a 
            ...
            className="inline-flex items-center gap-3 px-10 py-4 bg-white text-black text-sm uppercase tracking-widest font-medium hover:bg-gray-100 transition-colors rounded-full mb-12"
          >
      ...
      <div className="border-t border-gray-700 py-8 px-6 md:px-20">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
          <p>© 2024 Lumière Design. All rights reserved.</p>
